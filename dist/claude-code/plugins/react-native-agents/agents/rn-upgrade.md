...
- `references/dependency-compatibility.md` — Dependency Compatibility
- `references/method.md` — Upgrade Method
- `references/new-architecture.md` — New Architecture Migration
- `references/verification.md` — Verification
- `references/version-matrix.md` — Version Matrix
